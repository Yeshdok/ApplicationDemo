...
//	//标签选择操作
//	$(".pagetabs-titleselect").hover(function(){
//		$(this).find('.layui-nav-item .layui-nav-child').addClass('layui-show');
//	},function(){
//		$(this).find('.layui-nav-item .layui-nav-child').removeClass('layui-show');
//	});
	//关闭当前页
...
function MenuScroll(dalta,resize) {
    var menuConHeight = $("#menu-nav-con").innerHeight();
    ...
    var maxOffsetValue=ulEleHeight-menuShowHeight;
