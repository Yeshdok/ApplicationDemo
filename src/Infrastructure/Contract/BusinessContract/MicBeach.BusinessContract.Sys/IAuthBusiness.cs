...
namespace MicBeach.BusinessContract.Sys
{
    /// <summary>
    /// 权限业务接口
    /// </summary>
    public interface IAuthBusiness
    {
        ...
        /// <returns></returns>
        Result ModifyAuthorityGroupSort(ModifyAuthorityGroupSortCmdDto sortIndexInfo);
        ...
        /// <returns>执行结果</returns>
        Result ModifySortIndex(ModifyAuthorityOperationGroupSortCmdDto sortInfo);
